...
namespace LidStatusService
{
    public class Lid
    {
        ...
        private static extern IntPtr RegisterServiceCtrlHandlerEx(string lpServiceName, ServiceControlHandlerEx serviceControlHandler, IntPtr context);
        ...
        private static Guid _guidLidSwitchStateChange = new Guid(0xBA3E0F4D, 0xB817, 0x4094, 0xA2, 0xD1, 0xD5, 0x63, 0x79, 0xE6, 0xA0, 0xF3);
        ...
        public bool RegisterLidEventNotifications(IntPtr serviceHandle, string serviceName,  Action<bool> lidEventHandler)
        {
            ...
            _powerSettingsNotificationHandle = RegisterPowerSettingNotification(serviceHandle, ref _guidLidSwitchStateChange, DeviceNotifyServiceHandle);
        ...
        {
            return ((PowerBroadcastSetting)Marshal.PtrToStructure(lpEventData, typeof(PowerBroadcastSetting))).Data != 0;
        }
